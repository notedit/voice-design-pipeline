...
def greedy_groups(rows, mr):
    """贪心归组(纯函数,可测):rows 为 merge input 行,mr 为 MergeReviewConfig。
    产品策略见 MergeReviewConfig 注释:打包到 pref_max_dur,弹性区只在
    >= good_gap 的好断点断开,到 max_dur 回溯到组内最大间隙。"""
